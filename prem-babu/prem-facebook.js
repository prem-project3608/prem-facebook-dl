const prem_facebook = (videoUrl, cookie, useragent) => {
...
// prem_facebook("https://www.facebook.com/watch?v=272591278381388").then(console.log).catch(console.log);



module.exports = prem_facebook;
